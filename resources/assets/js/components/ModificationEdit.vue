    ...
    <div>
        <form enctype="multipart/form-data" role="form" method="POST" :action="'/mods/modifications/' + mod.id + '/update'">
            ...
            <div class="form-control">
                ...
                <datepicker :value="release_date" name="version"></datepicker>
            </div>
    ...
    export default {
        ...
        methods: {
            assignData({category, game, auth, mod}) {
                ...
                this.auth = auth;
                this.mod = mod;
                this.size = {value: mod.size, label: 'Zmień wybraną wielkość'};
                this.description = mod.description;
                this.development_status = {value: mod.development_status, label: 'Zmień wybrany status'};
