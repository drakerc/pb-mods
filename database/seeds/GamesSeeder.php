...
class GamesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('games')->insert([
            ...
            ['id' => 2, 'title' => 'The Elder Scrolls V Skyrim', 'description' => "The Elder Scrolls V: Skyrim to kolejna część serii cRPG autorstwa zespołu Bethesda Softworks. Ponownie odwiedzamy w niej kontynent Tamriel, a fabuła tym razem obraca się wokół powrotu do tej krainy pradawnej rasy smoków."],
            ['id' => 3, 'title' => 'Fallout 3', 'description' => "Fallout 3 to kolejna odsłona kultowej serii z gatunku cRPG, zapoczątkowanej w 1997 roku. Opracowaniem niniejszej części cyklu zajęli się twórcy gry The Elder Scrolls IV: Oblivion, wykorzystując jej ulepszony silnik. Aczkolwiek przykładowo system animacji i efektów świetlnych zaprojektowano od podstaw."],
        ]);
    }
}
